...
typedef struct {
  ...
  void (*on_close)(Cronet_WebSocketPtr ws,
                   void* user_data,
                   int was_clean,
                   uint16_t code,
                   const char* reason);
  ...
  void (*on_error)(Cronet_WebSocketPtr ws,
                   void* user_data,
                   int net_error,
                   const char* message);
...
CRONET_EXPORT int Cronet_WebSocket_Connect(Cronet_WebSocketPtr ws,
                                           const char* url,
...
CRONET_EXPORT int Cronet_WebSocket_Send(Cronet_WebSocketPtr ws,
                                        Cronet_WebSocket_MessageType type,
                                        const void* data,
                                        uint64_t len);
...
CRONET_EXPORT int Cronet_WebSocket_Close(Cronet_WebSocketPtr ws,
                                         uint16_t code,
                                         const char* reason);
